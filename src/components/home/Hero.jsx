    ...
    <section>
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-10 gap-y-5 2xl:items-center pb-10 lg:pb-[120px] pt-16 lg:pt-32 2xl:pt-56 relative container px-5 lg:px-10">
        <div className="relative order-last lg:order-first lg:justify-self-start justify-self-center w-full">
          ...
          >
            Most Popular <br className="sm:hidden" />
            eCommerce <br />
            Website Builder in Bangladesh. <br /> Create Your{" "}
            <span className={`${styles.archivo} text-[#f1593a] font-black`}>
              {" "}
              Online Store <br className="hidden sm:block" /> in Just 1 Min.{" "}
            </span>
          </h1>
          <p
          ...
          >
            {bangla
              ? "Looking to launch your online store in Bangladesh? Discover top E-commerce website builder customized for the Bangladeshi market. Create a personalized, user-friendly E-commerce  to showcase your products and grow your business online now."
              : "Looking to launch your online store in Bangladesh? Discover top E-commerce website builder customized for the Bangladeshi market. Create a personalized, user-friendly E-commerce  to showcase your products and grow your business online now."}
          </p>
          <HeroRegister />
        </div>
