    ...
    <section className="lg:py-[80px] py-10 relative z-[1] bg-[#F9F7F6]">
      ...
      <div className="relative z-[1] container px-5 lg:px-10 rounded-[10px] xl:-mt-24 lg:-mt-10 -mt-6">
        <div className="text-center">
          ...
          >
            Build your e-commerce today. No credit card needed
          </h4>
        </div>
        <div className="lg:flex gap-1 lg:gap-10 w-full justify-center mt-12">
          <form onSubmit={handleSubmit(handleRegister)}>
            <div className="flex gap-2 w-full">
              <div className="w-full ">
                <input
                  ...
                  className={`w-full ${
                    styles.archivo
                  } lg:w-[260px] px-2 w-full h-10 lg:h-12 text-xs sm:text-sm shadow-2xl ${
                    styles.archivo
                  } placeholder:text-[#D3CDCB] ${
                ...
                {(errors.phone?.type === "minLength" ||
                  errors.phone?.type === "maxLength") && (
                  <p className="text-xs text-red-500 block" role="alert">
              ...
              <div className="w-full relative">
                <input
                  ...
                  className={`w-full ${
                    styles.archivo
                  } lg:w-[260px] w-full px-2 h-10 lg:h-12 text-xs sm:text-sm shadow-2xl ${
                    styles.archivo
                  } placeholder:text-[#D3CDCB] ${
            ...
            <div className="flex items-center justify-center mt-5 lg:mt-0">
              {loading ? (
                <button
                  className={`group relative h-[34px] sm:h-[48px] lg:w-48 w-28 overflow-hidden rounded bg-[#f1593a] text-[12px] lg:text-lg shadow lg:ml-32`}
                >
                  <div
                ...
                <button
                  type="submit"
                  className={`group relative   overflow-hidden rounded bg-[#f1593a] text-[12px] lg:text-lg shadow lg:ml-32 px-3 md:py-2 py-1`}
                >
                  <div
                    className={`absolute inset-0 w-0 bg-[#000] transition-all duration-[250ms] ease-out group-hover:w-full`}
                  ></div>
                  {/* h-[34px] sm:h-[48px] */}
                  <span
                    className={`${styles.archivo} relative text-white flex justify-around items-center gap-3`}
                  >
              ...
              <Image
                src={images?.arrow}
                alt="ebitans image"
                className="rotate-[90deg] -ml-7 hidden lg:block"
              />
            </div>
          </form>
        </div>
