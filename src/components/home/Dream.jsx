            ...
            <div className='container px-5 lg:px-10'>
                ...
                <div className='mt-5 grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-5 bg-[#F9F7F6] relative z-[1]'>
                    ...
                    <div className='bg-[#F4E8E6] space-y-5 p-3 rounded'>
                        ...
                        <h4 className={`${styles.archivo} ${styles.headerFour}`}>Register to eBitans</h4>
                        <p className={`${styles.archivo} ${styles.paragraph} text-[#726A69]`}>Get your business online with eBitans. Sign up now with your phone number and password.</p>
                    </div>
                    <div className='bg-[#F4F1E6] space-y-5 p-3 rounded'>
                        ...
                        <p className={`${styles.archivo} text-[#726A69] ${styles.paragraph}`}>Get the power to build a beautiful, functional & complete e-commerce website with no coding required.</p>
                    </div>
                    <div className='bg-[#E6F0F4] space-y-5 p-3 rounded'>
                        ...
                        <p className={`${styles.archivo} ${styles.paragraph} text-[#726A69]`}>Launch your dream online store in 1 minute with eBitans. Turn your passion into profit. </p>
                    </div>
                </div>
            </div>
