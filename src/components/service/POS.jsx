        ...
        <div className="lg:pr-6 ">
          <div className="flex flex-col pr-4 space-y-2 pb-4 max-w-lg">
            ...
            <p className="text-[14px]  text-[#8d8d8d] text-justify pt-2 pb-5">
              The use of point-of-sale (POS) software now makes business
              accounting much more accessible and error-free. In modern times,
              an efficient point-of-sale system is essential to meet the overall
              needs of all types of businesses. So we E-bitans offer advanced
              quality Point of Sale (POS) facility at a low cost. Using it, past
              transactions can be viewed easily, can maintain accurate records
              or accounts of daily incoming and outgoing transactions made by
              the business. If you want to see how much you have sold in any
              previous day, Point of Sale (POS) will show you all the financial
              status in a moment with just one click.
            </p>
