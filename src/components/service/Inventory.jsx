        ...
        <div className="order-1 lg:order-2 pb-4 lg:pl-4">
          <div className="flex flex-col space-y-2 max-w-lg">
            ...
            <p className="text-[14px] text-[#8d8d8d] whitespace-normal text-justify pt-2 pb-5">
              Through the Inventory management software tool eBitans aims to
              serve small and medium enterprises in the country to facilitate
              their business accountings in an extensive way. All the
              necessities in business like the product stock report, sales
              transaction report can be done accurately, also can avoid stock
              outs and excess stock. This inventory management system allows you
              to receive the alert in time before any of your products run out
              of stock, so you can easily refill or relieve from mistakes like
              stockpiling of extra products.
            </p>
