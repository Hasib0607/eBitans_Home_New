        ...
        <div className=" sm:mt-0 order-1 lg:order-2 pb-4 lg:pl-4 ">
          <div className="flex flex-col space-y-2 max-w-lg">
            ...
            <p className="text-[14px]  text-[#8d8d8d] text-justify pt-2 pb-5">
              Make your own website in your way. One platform with all the
              E-commerce features you need to start, run, and grow your
              business. We eBitans are no code a website builder system for
              small, and medium business, offers reliable website hosting,
              domain name registration service, free themes, design layouts,
              mobile apps, facility to customize images, and much more. Add your
              own unique products to your website and create attractive
              descriptions for them. You don’t need coding skills to create a
              world-className E-commerce website that stands out both online and
              offline.
            </p>
            {data && (
