        ...
        <div className="lg:pl-6 lg:order-last">
          <div className="flex flex-col space-y-2 pr-4 pb-4 max-w-lg">
            ...
            <p className="text-[14px]  text-[#8d8d8d] text-justify pt-2 pb-5">
              Having a visually eye-capturing online advertisement can help
              promote, target, and display your business brand to millions of
              potential buyers. With eBitans as your professional display
              advertising agency, your business can create tailored banners,
              images, colors, dynamic texts, videos, logos, and ad extensions.
              We can also retarget anyone who interacts with your ads to keep
              your brand showing up wherever they go on the web.
            </p>
