        ...
        <div className="lg:pr-6">
          <div className="flex flex-col space-y-2 pr-4 pb-4 max-w-lg">
            ...
            <p className="text-[14px]  text-[#8d8d8d] text-justify pt-2 pb-5">
              eBitans Mobile App is new innovation for E-commerce business
              entrepreneurs. Suppose you are looking for the easiest way to
              create an E-commerce app for your business, in that case, we
              eBitans provide the easy solution to develop an E-commerce app
              will greatly contribute to the growth of the business and compete
              better in the market. Our E-commerce apps are quite simple and
              beautiful, just need to follow a few steps to create which
              provides a boundless shopping experience with delivering various
              types of products and services to customers' doorsteps. The most
              exciting thing is, you don't have to spend lacs to make high a
              functional mobile app from eBitans.
            </p>
