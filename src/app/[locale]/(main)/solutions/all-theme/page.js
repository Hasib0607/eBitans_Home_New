          ...
          <div className="grid grid-cols-2 gap-2">
            ...
            <div className="flex items-end justify-end pr-2 pb-2">
              <a
                ...
                className="bg-[#fff] text-[#f1593a] font-semibold text-center rounded-md py-2 drop-shadow-lg shadow-md hover:text-[#fff] border-[#f1593a] hover:border-[#f1593a] hover:bg-[#f1593a] border-2 outline-0 duration-500 px-6"
              >
                View Demo
              </a>
            </div>
