...
const featuresData = [
  {
    ...
    subTitle:
      "Our unlimited bandwidth and super-fast web hosting ensure uninterrupted and faster actions to run your online store. ",
    subTitleBd:
      "eBitans আপনাকে সম্পূর্ণ React.JS দিয়ে নির্মিত ই-কমার্স ওয়েবসাইট অফার করে যা দ্রুত তম সময়ে অনলাইন কেনাকাটায় গ্রাহকের ব্যক্তিগত অভিজ্ঞতাকে অনেক বেশি আনন্দদায়ক করবে।",
  },

  {
    ...
    subTitle:
      "Our unlimited bandwidth and super-fast web hosting ensure uninterrupted and faster actions to run your online store. ",
    subTitleBd:
      "আমাদের আনলিমিটেড ব্যান্ডউইথ এবং সুপার ফাস্ট ওয়েব হোস্টিং আপনার অনলাইন স্টোর চালানোর জন্য দ্রুততার সাথে নিরবচ্ছিন্ন সেবা নিশ্চিত করে। ",
  },

  {
    ...
    subTitle:
      "This Inventory management software gives the facility to control, and keep track of your product inventory, sales, and accounts",
    subTitleBd:
      "এই ইনভেন্টরি ম্যানেজমেন্ট সফ্টওয়্যারটি আপনার সঠিক পণ্য সরবরাহ, বিক্রয় এবং অ্যাকাউন্ট নিয়ন্ত্রণ করার পাশাপাশি  সহজে পণ্যের স্টক ট্র্যাক রাখার সুবিধা প্রদান করে। ",
  },

  {
    ...
    subTitle:
      "We demand no fees, no price to provide a subdomain in separate so that you can create your desired website hassle-free.",
    subTitleBd:
      "আমরা আলাদাভাবে সাবডোমেইন প্রদান করার জন্য কোন ফি বা কোন মূল্য দাবি করি না, যাতে করে আপনি আপনার পছন্দসই ওয়েবসাইটটি ঝামেলাহীন ভাবে তৈরি করতে পারেন।",
  },

  {
    ...
    subTitle:
      "Are you tensed about the expenses to build an E-commerce website? No worries, our package starts at a surprisingly low price.",
    subTitleBd:
      "Aআপনি কি একটি ইকমার্স ওয়েবসাইট তৈরির খরচ নিয়ে টেনশনে আছেন? চিন্তার কিছু নেই, আমাদের  বিভিন্ন প্যাকেজগুলো  আপনাকে দিচ্ছে আশ্চর্যজনকভাবে কম দামে ওয়েবসাইট তৈরির সুবিধা ।",
  },

  {
    ...
    subTitle:
      "Building a website now is super easy. Using our eBitans platform you can make your dream website within just a few clicks.",
    subTitleBd:
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 lg:gap-20 container px-5 lg:px-10">
        <div className="pt-16 gap-y-10">
          ...
          <p className="py-5 text-gray-500 font-light font-Railway whitespace-pre-wrap tracking-widest leading-loose">
            eBitans is the platform where you can create an E-commerce website
            for your business with just a matter of a few clicks. eBitans also
            offers E-commerce Mobile Apps, Point of Sale (POS), and Inventory
            Management System integrated with various features that simplify the
            selling process and increase your business revenue. In a word,
            eBitans provides Entrepreneurs an excellent solution to build
            sustainable stores online to sell their products online and also
        ...
        <div className="container lg:block flex justify-center pb-6">
          <div className="grid grid-cols-1 md:grid-cols-2 justify-center lg:grid-cols-3 gap-3">
            {featuresData?.map((data, id) => (
              <SingleCircular data={data} key={id} />
            ))}
          </div>
        </div>
      </div>
