        ...
        <div className="pt-40">
          <h1 className="text-4xl text-[#333] font-semibold font-Railway tracking-widest py-10 ">
            {!bangla
              ...
              : "ব্যবসাকে দ্রুত এবং সফলভাবে পরিচালনা করুন"}
          </h1>
          <p className="text-[20px] pt-5 text-gray-500 font-light font-Railway leading-[32px]">
            {!bangla
              ? "We know that when you grow your business, it is not just about yourself."
              : "আমরা জানি যে, আপনার ব্যবসার প্রসারের জন্য পণ্যকে গ্রাহকের দোরগোড়ায় পৌঁছানো অত্যাবশ্যক। যার সহজ ও দ্রুততম মাধ্যম হচ্ছে সোশ্যাল মিডিয়া মার্কেটিং।"}
          </p>
          <p className="text-[20px] pt-3 pb-5 text-gray-500 font-light font-Railway leading-[32px]">
            {!bangla
              ? "To grow your business faster there is no alternative of attractive content for your business. But you may not know where to start, we’re here to make your life more easier! Therefor, we are here to help you to make a social media ready content. which not only help to grow your business also give your business a better look. Let us handle everything and create a strategy that will help grow your business 10X more on online."
              : "ব্যবসাকে দ্রুত বৃদ্ধি করতে আকর্ষণীয় কনটেন্ট এর কোন বিকল্প নেই। কিন্তু কোথা থেকে শুরু করবেন তা হয়তো আপনি বুঝতে পারছেন না। আপনার এই ঝামেলার সমাধান নিয়ে এসেছে eBitans। অনলাইনে আপনার ব্যবসার প্রসারের জন্য যাবতীয় কনটেন্ট সাপোর্ট, ফেইসবুক বুষ্টিং দিবে eBitans এবং একি সাথে আপনার ব্যবসার ধরন অনুযায়ী বেব্সায়িক কৌশল নির্বাচন করব যা আপনার ব্যবসার বৃদ্ধিকে দশগুণ বেশি গতি প্রদান করবে।"}
          </p>
        </div>
